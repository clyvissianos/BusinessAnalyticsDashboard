    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RawImports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RawImports_DataSources_DataSourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataSources_OwnerId_CreatedAtUtc",
                table: "DataSources",
                columns: new[] { "OwnerId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_RawImports_DataSourceId_Status",
                table: "RawImports",
